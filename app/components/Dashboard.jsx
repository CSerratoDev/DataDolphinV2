...
/**
 * @param {{ user: any; onSelectTramite: any; onLogout: any; inProgress?: any[] }} props
 */
export default function Dashboard({ user, onSelectTramite, onLogout, inProgress = /** @type {any[]} */ ([]) }) {
